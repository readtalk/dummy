...
export default function Welcome() {
  return (
    <main className="flex items-center justify-center pt-16 pb-4 min-h-screen bg-white px-6">
      <div className="flex-1 flex flex-col items-center gap-16 min-h-0 w-full max-w-md">
        ...
        <div className="max-w-[300px] w-full space-y-6 px-4">
          ...
          <h1 className="text-3xl text-black font-normal text-center">
            Welcome to ReadTalk
          </h1>

          <p className="text-center text-gray-600 text-sm leading-5">
            Read our{" "}
