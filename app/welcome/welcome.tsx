...
export function Welcome() {
  return (
    <main className="min-h-screen bg-[#f6f6f6] relative">
      ...
      {/* Icon accessibility */}
      <button className="absolute top-[88px] right-[20px] w-[40px] h-[40px] border border-[#dadce0] rounded-full bg-white flex items-center justify-center">
      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-[32px]">
        <div className="w-full max-w-[328px] flex flex-col items-center text-center">

          <div className="w-[152px] h-[152px] mb-[48px]">
            <img src={logo} alt="READTalk" className="w-full h-full" />
          </div>

          <h1 className="text-[28px] leading-[36px] font-normal text-[#0c1317] mb-[12px]">
            Welcome to READTalk
          </h1>
          ...
          <button className="bg-[#f1f3f4] rounded-full px-[24px] py-[10px] mb-[24px] flex items-center gap-[8px] text-[#202124] text-[15px]">
